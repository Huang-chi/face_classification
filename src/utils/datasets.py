...
def English_2_chinese_emotion(emotion_text):
    emotion_dict = {'angry':"生氣", 'disgust':"噁心",'fear':"恐懼",'happy':"開心",
                'sad':"悲傷",'surprise':"驚訝",'neutral':"無表情"}
    return emotion_dict[emotion_text]

def English_2_chinese_gender(gender_text):
    gender_dict = {'woman':"女",'man':"男"}
    return gender_dict[gender_text]
